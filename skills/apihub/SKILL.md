---
name: apihub
description: Entry point for apihub — local/remote AI gateway with OpenAI-compatible REST for chat, image, TTS, embeddings, web search, web fetch. Use when the user mentions apihub, NINEROUTER_URL, or wants AI without writing provider boilerplate. This skill covers setup + indexes capability skills; fetch the relevant capability SKILL.md from the URLs below when needed.
---
...
```bash
export NINEROUTER_URL="http://localhost:20321"      # or VPS / tunnel URL
